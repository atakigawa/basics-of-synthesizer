(ns basics-of-synthesizer.inst.guitar-synth
...
(do
  (guitar-pick g 0 8 (+ (now) 20 0))
  (guitar-pick g 1 9 (+ (now) 20 100))
  (guitar-pick g 2 10 (+ (now) 20 215))
  (guitar-pick g 3 11 (+ (now) 20 350))
  (guitar-pick g 4 12 (+ (now) 20 480))
  (guitar-pick g 5 13 (+ (now) 20 620))
  )
(ctl g :noise-amp 0.8)
(ctl g :pre-amp 10)
(ctl g :rvb-mix 0.8)
(ctl g :rvb-room 0.8)
(ctl g :noise-amp 0.8 :pre-amp 6.0 :distort 0 :rvb-mix 0 :rvb-room 0)
